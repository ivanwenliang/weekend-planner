...
CREATE TABLE Events (eventid INT, ename varchar(100), location varchar(100), eventdate varchar(50), starttime varchar(20), PRIMARY KEY(eventid));
...
-- CREATE TABLE Review (review varchar(500),ename varchar(100), attenddate date, rating INT,PRIMARY KEY(ename,attenddate),
